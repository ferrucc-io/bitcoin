...
var G__21249 = o;
(G__21249[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__21250__delegate = function (args){
...
while (G__21251__i < G__21251__a.length) {G__21251__a[G__21251__i] = arguments[G__21251__i + 0]; ++G__21251__i;}
  args = new cljs.core.IndexedSeq(G__21251__a,0,null);
} 
return G__21250__delegate.call(this,args);};
G__21250.cljs$lang$maxFixedArity = 0;
G__21250.cljs$lang$applyTo = (function (arglist__21252){
var args = cljs.core.seq(arglist__21252);
return G__21250__delegate(args);
});
...
var G__21253 = o;
(G__21253[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__21254__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__21255__i < G__21255__a.length) {G__21255__a[G__21255__i] = arguments[G__21255__i + 0]; ++G__21255__i;}
  args = new cljs.core.IndexedSeq(G__21255__a,0,null);
} 
return G__21254__delegate.call(this,args);};
G__21254.cljs$lang$maxFixedArity = 0;
G__21254.cljs$lang$applyTo = (function (arglist__21256){
var args = cljs.core.seq(arglist__21256);
return G__21254__delegate(args);
});
...
var G__21258 = props;
var G__21258__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21258,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21258);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21258__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21259){
...
var props = map__21260__$1;
var class$ = cljs.core.get.call(null,map__21260__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21260,map__21260__$1,props,class$){
return (function (c){
...
});})(map__21260,map__21260__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21262){
...
var on_write = cljs.core.get.call(null,map__21263__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21263,map__21263__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21263,map__21263__$1,on_write))
);
} else {
...
var G__21266 = jsprops;
(G__21266["defaultValue"] = value);

(G__21266["onChange"] = ((function (G__21266,v,value,on_change){
return (function (p1__21265_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21265_SHARP_);
});})(G__21266,v,value,on_change))
);
...
var vec__21269 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21269,(0),null);
var id = cljs.core.nth.call(null,vec__21269,(1),null);
var class$ = cljs.core.nth.call(null,vec__21269,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___21273 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___21273 == null)){
} else {
var key_21274 = temp__5461__auto___21273;
(jsprops["key"] = key_21274);
}
...
var temp__5461__auto___21275 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___21275 == null)){
} else {
var key_21276 = temp__5461__auto___21275;
reagent.impl.template.oset.call(null,jsprops,"key",key_21276);
}
...
var G__21277 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21277["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21281){
var G__21282 = cljs.core.first.call(null,seq21281);
var seq21281__$1 = cljs.core.next.call(null,seq21281);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21282,seq21281__$1);
});
...
break;
default:
var G__21288 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21288;
continue;
...
var n__4607__auto___21290 = a.length;
var i_21291 = (0);
while(true){
if((i_21291 < n__4607__auto___21290)){
(a[i_21291] = reagent.impl.template.as_element.call(null,(a[i_21291])));

var G__21292 = (i_21291 + (1));
i_21291 = G__21292;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21293 = a.length;
var i_21294 = (0);
while(true){
if((i_21294 < n__4607__auto___21293)){
var val_21295 = (a[i_21294]);
if(((cljs.core.vector_QMARK_.call(null,val_21295)) && ((reagent.impl.template.key_from_vec.call(null,val_21295) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21294] = reagent.impl.template.as_element.call(null,val_21295));

var G__21296 = (i_21294 + (1));
i_21294 = G__21296;
continue;
} else {
}
...
var ctx = ({});
var vec__21297 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21297,(0),null);
var derefed = cljs.core.nth.call(null,vec__21297,(1),null);
...
var G__21300 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21300) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21300){
...
//# sourceMappingURL=template.js.map?rel=1553263585046
