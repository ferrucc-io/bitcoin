...
return (new CustomEvent(event_name,(function (){var obj24150 = ({"detail":data});
return obj24150;
})()));
} else {
...
var f = (function (){var pred__24157 = cljs.core._EQ_;
var expr__24158 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__24157.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__24158))){
return ((function (pred__24157,expr__24158){
return (function (p1__24151_SHARP_){
return console.warn(p1__24151_SHARP_);
});
;})(pred__24157,expr__24158))
} else {
if(cljs.core.truth_(pred__24157.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__24158))){
return ((function (pred__24157,expr__24158){
return (function (p1__24152_SHARP_){
return console.debug(p1__24152_SHARP_);
});
;})(pred__24157,expr__24158))
} else {
if(cljs.core.truth_(pred__24157.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__24158))){
return ((function (pred__24157,expr__24158){
return (function (p1__24153_SHARP_){
return console.error(p1__24153_SHARP_);
});
;})(pred__24157,expr__24158))
} else {
return ((function (pred__24157,expr__24158){
return (function (p1__24154_SHARP_){
return console.log(p1__24154_SHARP_);
});
;})(pred__24157,expr__24158))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__24161){
...
var opts = map__24162__$1;
var eval_fn = cljs.core.get.call(null,map__24162__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__24164_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__24166,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1553263590548
