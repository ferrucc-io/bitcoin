...
return [(function (){var pred__21416 = cljs.core.instance_QMARK_;
var expr__21417 = reactive_val;
if(cljs.core.truth_(pred__21416.call(null,reagent.ratom.RAtom,expr__21417))){
return "ra";
} else {
if(cljs.core.truth_(pred__21416.call(null,reagent.ratom.RCursor,expr__21417))){
return "rc";
} else {
if(cljs.core.truth_(pred__21416.call(null,reagent.ratom.Reaction,expr__21417))){
return "rx";
} else {
if(cljs.core.truth_(pred__21416.call(null,reagent.ratom.Track,expr__21417))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1553263585424
