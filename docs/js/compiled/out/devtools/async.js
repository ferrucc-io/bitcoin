...
var o__24205__auto___26032 = (function (){var o__24205__auto__ = (function (){var o__24205__auto__ = Promise;
return (o__24205__auto__["resolve"]).call(o__24205__auto__);
})();
return (o__24205__auto__["then"]).call(o__24205__auto__,callback);
})();
(o__24205__auto___26032["catch"]).call(o__24205__auto___26032,devtools.async.rethrow_outside_promise);
...
var G__26033_26034 = Error;
var target__24210__auto___26035 = G__26033_26034;
if(cljs.core.truth_(target__24210__auto___26035)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__26033_26034)].join(''),"\n","target__24210__auto__"].join('')));
}

(target__24210__auto___26035["stackTraceLimit"] = Infinity);
...
//# sourceMappingURL=async.js.map?rel=1553263593724
